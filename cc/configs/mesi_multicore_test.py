# configs/mesi_multicore_test.py
import m5
...
system.cc = [MesiCache(cache_id=i, serializing_bus=system.serializing_bus, blockOffset=6, setBit=3, cacheSizeBit=12) for i in range(N)]
