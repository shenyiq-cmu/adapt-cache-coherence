...
N = 4  # Start with 2 cores for basic testing
...
system.cc = [HybridCache(cache_id=i, serializing_bus=system.serializing_bus, 
                      blockOffset=0, setBit=0, cacheSizeBit=1, invalidThreshold=5) for i in range(N)]
