...
public:
    ...
    std::vector<cacheSetMgr> HybridCacheMgr;
    ...
    HybridCache(const HybridCacheParams &params);
    ...
    const char* getStateName(HybridState state) {
        switch (state) {
            case HybridState::INVALID: return "INVALID";
            case HybridState::EXCLUSIVE: return "EXCLUSIVE";
            case HybridState::MODIFIED: return "MODIFIED";
            case HybridState::SHARED_CLEAN: return "SHARED_CLEAN";
            case HybridState::SHARED_MOD: return "SHARED_MOD";
